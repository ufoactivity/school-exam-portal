...
st.info("💡 終極優化：已實裝「30分鐘實作科目的獨立/合併雙軌口試時間表」，並具備考試流程與時間衝突雙重防呆檢核！")
...
# 【更新】獨立科目的 30 分鐘實作口試時間表（官方版本）
ORAL_30_MATRIX_INDEPENDENT = {
    1: "10:40-10:50", 2: "11:10-11:20", 3: "11:40-11:50", 4: "13:10-13:20",
    5: "14:10-14:20", 6: "14:40-14:50", 7: "15:10-15:20", 8: "15:40-15:50",
    9: "16:10-16:20", 10: "16:40-16:50", 11: "17:10-17:20", 12: "17:40-17:50",
    13: "18:10-18:20", 14: "18:40-18:50", 15: "19:10-19:20",
}

# 【更新】合併科目的 30 分鐘實作口試時間表（接力版本）
...
with col2:
    ...
    2. **雙軌矩陣**：系統能自動偵測 30 分鐘實作科目是否為獨立應考，並精準配對專屬口試時間。
                    ...
                    for i in range(n_candidates):
                        ...
                        if is_practical:
                            ...
                            if is_merged_group:
                                ...
                                oral_range = ORAL_30_MATRIX_INDEPENDENT.get(global_idx, "請手動調整")
                        else:
