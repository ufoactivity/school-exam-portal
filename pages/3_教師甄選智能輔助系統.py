...
st.info("💡 終極優化：已實裝「30分鐘實作獨立科目的動態交錯口試表」，根據總人數緊密排程，評委不再空等，且具備時間衝突雙重防呆檢核！")
...
# 【全新更新】獨立科目的 30 分鐘實作口試時間表 (依總人數動態交錯緊密排程，消滅評委空檔！)
ORAL_30_MATRIX_INDEPENDENT = {
    1: {1: "10:40-10:50"},
    2: {1: "10:40-10:50", 2: "10:55-11:05"},
    3: {1: "10:40-10:50", 2: "10:55-11:05", 3: "10:25-10:35"},
    4: {1: "10:55-11:05", 2: "11:10-11:20", 3: "10:25-10:35", 4: "10:40-10:50"},
    5: {1: "10:55-11:05", 2: "11:10-11:20", 3: "10:25-10:35", 4: "10:40-10:50", 5: "14:10-14:20"},
    6: {1: "10:55-11:05", 2: "11:10-11:20", 3: "10:25-10:35", 4: "10:40-10:50", 5: "14:25-14:35", 6: "14:40-14:50"},
    7: {1: "10:55-11:05", 2: "11:10-11:20", 3: "10:25-10:35", 4: "10:40-10:50", 5: "14:10-14:20", 6: "14:25-14:35", 7: "13:55-14:05"},
    8: {1: "10:55-11:05", 2: "11:10-11:20", 3: "10:25-10:35", 4: "10:40-10:50", 5: "14:25-14:35", 6: "14:40-14:50", 7: "13:55-14:05", 8: "14:10-14:20"},
    9: {1: "10:55-11:05", 2: "11:10-11:20", 3: "10:25-10:35", 4: "10:40-10:50", 5: "14:40-14:50", 6: "14:55-15:05", 7: "13:55-14:05", 8: "14:10-14:20", 9: "14:25-14:35"},
    10: {1: "10:55-11:05", 2: "11:10-11:20", 3: "10:25-10:35", 4: "10:40-10:50", 5: "14:55-15:05", 6: "15:10-15:20", 7: "13:55-14:05", 8: "14:10-14:20", 9: "14:25-14:35", 10: "14:40-14:50"}
}

# 【合併專用】合併科目的 30 分鐘實作接力口試時間表 (因為要等第一組考完，所以往後平移)
...
with col2:
    ...
    2. **雙軌矩陣**：系統能自動偵測 30 分鐘實作科目是否為獨立應考，並依照總人數緊密配對口試時間，委員不再空等。
                    ...
                    for i in range(n_candidates):
                        ...
                        if is_practical:
                            ...
                            if is_merged_group:
                                ...
                                # 【關鍵修正】：獨立科目採用「依照人數查表」的緊密邏輯
                                lookup_n = group_total_candidates if group_total_candidates <= 10 else 10
...
if st.session_state.processed:
    st.balloons()
    st.success("🎉 排版與邏輯皆完美達成！「獨立科目的30分鐘口試表」已正確分離，系統也將即時為您把關所有時間衝突。")
