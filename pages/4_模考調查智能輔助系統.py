...
st.info("💡 試務組終極進化：支援普高動態切換工作表！系統會根據您選擇的次數（第一次/第二次/仿真模考...）自動變換專屬警語與紅字提示！")
